...
async def cb_navg(bot, update: CallbackQuery):
    ...
    text=f"<i>If U didn't get any Movie,Tag @admin with your Movie Name</i> <code>{leng}</code> <i>Here Is The Results For:</i> <code>{query}</code>"
...
async def callback_data(bot, update: CallbackQuery):
    ...
    if query_data == "start":
        buttons = [[
            InlineKeyboardButton('Join',url='https://t.me/Channel_links_1'),
            InlineKeyboardButton('More Movie',url ='https://t.me/discussion_Group_2')
        ],[
            InlineKeyboardButton('Search Movie',url='https://t.me/discussion_Group_2')
        ],[
